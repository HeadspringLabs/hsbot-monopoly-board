...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass2 = __webpack_require__(239);
	...
	var _serverFetch = __webpack_require__(271);

	var _serverFetch2 = _interopRequireDefault(_serverFetch);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var dallas = new Image();
	var houston = new Image();
	var dmz = new Image();
	var deltaCity = new Image();
	var gotham = new Image();
	var monterrey = new Image();
	...
	var Board = function (_React$Component) {
	  ...
	  function Board(props) {
	    ...
	    _this.renderPieces = function () {
	      var canvas = document.getElementById('game-pieces');
	      var context = canvas.getContext('2d');
	      context.imageSmoothingEnabled = false;
	      context.clearRect(0, 0, canvas.width, canvas.height);

	      _this.renderPiece(0, deltaCity, context);
	      _this.renderPiece(1, gotham, context);
	      _this.renderPiece(2, dmz, context);
	      _this.renderPiece(3, houston, context);
	      _this.renderPiece(4, dallas, context);
	      _this.renderPiece(5, monterrey, context);
	    };

	    _this.getCurrentData = function () {
	      _serverFetch2.default.get().then(function () {
	    ...
	    _this.renderPiece = function (playerIndex, image, context) {
	      var player = _this.state.players[playerIndex];
	      if (!player.isBankrupt) {
	        var x = _this.calculateX(playerIndex, player.location);
	        var y = _this.calculateY(playerIndex, player.location);
	        context.drawImage(image, x, y, 60, 60);
	      }
	    };

	    _this.calculateX = function (index, location) {
	      var inJail = _this.state.players[index].inJail;
	      var position = inJail ? 28 : _constants.coordinates[location].x;
	      var piecesAtThatLocation = 0;
	      for (var i = 0; i < index; i += 1) {
	        var checkPlayer = _this.state.players[i];
	    ...
	    _this.calculateY = function (index, location) {
	      var inJail = _this.state.players[index].inJail;
	      var position = inJail ? 600 : _constants.coordinates[location].y;
	      var piecesAtThatLocation = 0;
	      for (var i = 0; i < index; i += 1) {
	        var checkPlayer = _this.state.players[i];
	    ...
	    _this.renderStatus = function () {
	      return _this.state.players.map(function (player) {
	        var location = 'is on ' + _this.state.board[player.location].name;
	        if (player.isBankrupt) {
	        ...
	        return _react2.default.createElement(
	          'div',
	          { key: player.name, className: 'team-status' },
	          player.name,
	          ' ',
	          location
	        );
	  ...
	  (0, _createClass3.default)(Board, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('img', { alt: 'board', className: 'board', src: '/images/HeadspringopolyBoard.png' }),
	        _react2.default.createElement('canvas', { id: 'game-pieces', height: '700', width: '700' }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var USE_NATIVE = !!function () {
	  try {
	    ...
	    var FakePromise = (promise.constructor = {})[__webpack_require__(208)('species')] = function (exec) {
	      exec(empty, empty);
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var anObject = __webpack_require__(180);
	var aFunction = __webpack_require__(177);
	var SPECIES = __webpack_require__(208)('species');
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function (test, buggy, set) {
	      try {
	        set = __webpack_require__(176)(Function.call, __webpack_require__(259).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  GET_HOST: (undefined) || 'http://hsbot-monopoly-board.azurewebsites.net/get',
	  DATA_URL: 'https://hsbot.blob.core.windows.net/hsbot-brain/brain-dump.json',
	  coordinates: [{ x: 600, y: 630 }, { x: 540, y: 630 }, { x: 485, y: 630 }, { x: 432, y: 630 }, { x: 378, y: 630 }, { x: 322, y: 630 }, { x: 268, y: 630 }, { x: 210, y: 630 }, { x: 156, y: 630 }, { x: 102, y: 630 }, { x: 8, y: 630 }, { x: 8, y: 540 }, { x: 8, y: 486 }, { x: 8, y: 431 }, { x: 8, y: 376 }, { x: 8, y: 321 }, { x: 8, y: 264 }, { x: 8, y: 210 }, { x: 8, y: 154 }, { x: 8, y: 99 }, { x: 8, y: 10 }, { x: 102, y: 10 }, { x: 156, y: 10 }, { x: 210, y: 10 }, { x: 268, y: 10 }, { x: 322, y: 10 }, { x: 378, y: 10 }, { x: 432, y: 10 }, { x: 485, y: 10 }, { x: 543, y: 10 }, { x: 600, y: 10 }, { x: 640, y: 99 }, { x: 640, y: 154 }, { x: 640, y: 210 }, { x: 640, y: 265 }, { x: 640, y: 321 }, { x: 640, y: 376 }, { x: 640, y: 432 }, { x: 640, y: 486 }, { x: 640, y: 541 }]
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var mapResponse = function () {
	  ...
	  return function mapResponse(_x) {
	    return _ref.apply(this, arguments);
	  };
	}();

	var proxyFetch = function proxyFetch() {
	  var request = {
	    method: 'GET',
	    headers: (0, _defineProperty3.default)({}, 'Content-Type', 'application/json')
	  };

	  return fetch(_constants.GET_HOST + '/data', request).then(mapResponse).catch(function (err) {
	    console.log(err);return { PROXY_ERROR: true };
	  });
	};
	      ...
	      return _regenerator2.default.wrap(function _callee2$(_context2) {
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            case 0:
	              return _context2.abrupt('return', proxyFetch('GET'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = window.fetch || (window.fetch = __webpack_require__(274).default || __webpack_require__(274));
